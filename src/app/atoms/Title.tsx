...
const Title:React.FC<TitleProps> = ( {title,subtitle,description } ) => (
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
   
  <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-orange-600 sm:text-7xl ">
